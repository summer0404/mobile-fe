...
const CategoryModalHeader: React.FC<CategoryModalHeaderProps> = ({
  ...
  return (
    <View className="flex-row items-center space-x-3 mb-4">
      <TextInput
        className="flex-1 bg-white p-3 rounded-lg text-black shadow-sm border border-slate-300"
        placeholder="Search"
      ...
      >
        ...
        <Text className="text-primary font-pmedium ml-1 text-sm">Create new</Text>
      </TouchableOpacity> */}
    </View>
  );
};
